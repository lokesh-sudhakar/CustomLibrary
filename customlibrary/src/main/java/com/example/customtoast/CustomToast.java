...
public class CustomToast {
    ...
    public CustomToast(Context context, @StringRes int msg, int leftDrawable, int topDrawable,int rightDrawable, int bottomDrawable,
    ...
    public static class Builder {
        ...
        public CustomToast build() {
            return new CustomToast(context, msg, leftDrawable, topDrawable,rightDrawable, bottomDrawable, toastBgColor, textColor, duration, gravity, xOffSet, yOffSet);
        }
    }
